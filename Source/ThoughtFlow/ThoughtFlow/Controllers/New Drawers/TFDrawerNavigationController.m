...
- (TFCustomBarButtonItem *) customLeftBarButtonItem {
    UIBarButtonItem *ret = self.visibleViewController.navigationItem.leftBarButtonItem;
    return (TFCustomBarButtonItem *) ([ret isKindOfClass: [TFCustomBarButtonItem class]] ? ret : nil);
}

- (TFCustomBarButtonItem *) customRightBarButtonItem {
    UIBarButtonItem *ret = self.visibleViewController.navigationItem.rightBarButtonItem;
    return (TFCustomBarButtonItem *) ([ret isKindOfClass: [TFCustomBarButtonItem class]] ? ret : nil);
}
@end